diff --git a/docs/VIRAL_DNA_EXTRACTOR_ARCHITECTURE.md b/docs/VIRAL_DNA_EXTRACTOR_ARCHITECTURE.md
new file mode 100644
index 0000000..b3310df
--- /dev/null
+++ b/docs/VIRAL_DNA_EXTRACTOR_ARCHITECTURE.md
@@ -0,0 +1,1449 @@
