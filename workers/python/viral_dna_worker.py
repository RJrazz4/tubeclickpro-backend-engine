...
def main() -> None:
    ...
    result = {
        ...
        "video": {
            ...
            "channelId": metadata.get("channel_id") if isinstance(metadata.get("channel_id"), str) else None,
        ...
        "channelDetails": {
            "id": str(metadata.get("channel_id") or ""),
            "title": str(metadata.get("channel") or metadata.get("uploader") or "Unknown channel"),
            "description": None,
            "customUrl": None,
            "subscriberCount": nullable_number(metadata.get("channel_follower_count")),
            "videoCount": None,
            "viewCount": None,
            "thumbnailUrl": None,
        } if metadata.get("channel_id") else None,
